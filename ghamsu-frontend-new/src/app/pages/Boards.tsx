...
export default function Boards() {
  const boards = [
    ...
    },
    {
      ...
      title: 'Audit Board',
      slug: 'audit-board',
      description: 'Ensuring financial accountability, transparency, and proper stewardship of the union resources across the connexion.',
      members: 6,
    },
    {
      icon: Users,
      title: 'Project Board',
      slug: 'project-board',
      description: 'Overseeing Union development projects, Ghamsu Souvenirs, and other initiatives to support the growth and sustainability of the church.',
      members: 9,
    },
    {
      icon: Globe,
  ...
  const activities = [
    {
      ...
      description: 'A biennial conference to bring all ambassadors together for fellowship, training, and strategic planning for the union.',
    ...
    },
    {
      ...
      date: 'To be communicated',
      location: 'To be communicated',
      description: 'Reaching the unreached with the gospel through evangelism, church planting, and humanitarian outreach in strategic locations across the connexion.',
