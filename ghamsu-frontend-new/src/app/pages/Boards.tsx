  ...
  return (
    <div>
      ...
      <div className="pb-24">
        ...
        {/* Major Activities */}
        <section className="px-4 sm:px-6 lg:px-8 py-16 sm:py-20 md:py-24 bg-secondary">
          <div className="max-w-[1400px] mx-auto">
            <AnimatedSection>
              <div className="mb-12 sm:mb-16">
                <div className="h-[1px] w-12 bg-accent mb-4" />
              ...
              {activities.map((activity, index) => (
                <AnimatedSection key={index} delay={index * 0.1}>
                  <div className="bg-card border border-border hover:border-accent/50 transition-all duration-500 overflow-hidden">
                    ...
                    <div className="p-6 sm:p-8">
                      <h3
                        className="text-xl sm:text-2xl mb-4 tracking-tight"
                        style={{ fontFamily: 'var(--font-heading)', fontWeight: 600 }}
                      >
                        {activity.title}
                      </h3>
                      <div className="space-y-2 mb-6 text-xs sm:text-sm text-muted-foreground font-light">
                        <p>{activity.date}</p>
                        <p>{activity.location}</p>
                      </div>
                      <p className="text-muted-foreground leading-relaxed font-light text-xs sm:text-sm mb-8">
                        {activity.description}
                      </p>
                      <button className="w-full border border-foreground/20 text-foreground py-3 text-xs sm:text-sm tracking-wider uppercase font-medium hover:bg-foreground/5 transition-all duration-300">
                        Learn More
                      </button>
                    </div>
                  </div>
