...
export function BlogDetailPage() {
  ...
  const related =
    allBlogs
      ?.filter((p) => p._id !== blog?._id && p.category === blog?.category)
      .slice(0, 3) ?? [];
      ...
      <div className="sticky top-0 z-40 bg-white/90 backdrop-blur-md border-b border-gray-100 shadow-sm">
        <div className="max-w-4xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-1 text-sm text-gray-400">
            ...
            <Link to="/blog" className="hover:text-orange-500 transition-colors">Articles</Link>
            {blog && (
              <>
                <ChevronRight className="w-4 h-4" />
          ...
          <div className="max-w-4xl mx-auto px-4 py-12">
            ...
            {blog.content ? (
              <div className="prose-article">
                <PortableText value={blog.content as any} components={ptComponents} />
              </div>
            ) : (
            ...
            <div className="mt-14 pt-8 border-t border-gray-100">
              ...
              <div className="flex flex-wrap gap-3">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 px-5 py-2.5 rounded-lg bg-[#1877f2] text-white text-sm font-semibold hover:bg-[#1464d8] transition-colors"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 px-5 py-2.5 rounded-lg bg-black text-white text-sm font-semibold hover:bg-gray-800 transition-colors"
                >
                  <Twitter className="w-4 h-4" /> X / Twitter
                </a>
                <button
                  onClick={copyLink}
                  className="flex items-center gap-2 px-5 py-2.5 rounded-lg bg-gray-100 text-gray-700 text-sm font-semibold hover:bg-gray-200 transition-colors"
                >
